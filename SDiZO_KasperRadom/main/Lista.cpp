...
void Lista::wydrukujListe() {
    cout << "Lista w normalnej kolejności:"<<endl;
    aktualnyElement = poczatek;                   //przypisujemy wskaznik na poczatek listy do aktualnego elementu
    for (int i = 0; i < liczbaElementow; i++) {         //przechodzimy przez cala liste i wyswietlamy elementy w formacie [indeks]wartosc
        cout << aktualnyElement->wartosc<<", ";
        aktualnyElement = aktualnyElement->kolejnyElement;
    }

    cout <<endl<< "Lista w odwrotnej kolejności:"<<endl;
    aktualnyElement = koniec;                   //przypisujemy wskaznik na poczatek listy do aktualnego elementu
    for (int i = 0; i < liczbaElementow; i++) {         //przechodzimy przez cala liste i wyswietlamy elementy w formacie [indeks]wartosc
        cout << aktualnyElement->wartosc << ", ";
        aktualnyElement = aktualnyElement->poprzedniElement;
    }
    cout<<endl;
}
