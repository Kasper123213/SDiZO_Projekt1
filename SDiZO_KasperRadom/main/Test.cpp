...
//wyszukiwanie elementu
            case 7:
                ...
                if (indeks < 0) {
                    ...
                    cout << "Wartość występuje na indeksie: " << indeks << " Czas wykonania: " << czas.czasWykonania()<< endl;
                }
                break;
...
//wstawianie danych z pliku
            case 9:
                ...
                // Przypisz wartości z pliku do tablicy
                int i = 0;
                int liczby;
                file >> liczby;

                for (liczby; liczby > 0; liczby--) {
                    file >> wartoscZPliku;
                    tablica.dodawanieNaKoniec(wartoscZPliku);
                }
...
void Test::testListy() {
    ...
    do {
        ...
        cout << "    9. Wstaw dane z pliku" << endl;
        cout << "    0. Wyjście" << endl;
        cout << "Wybór: ";
        cin >> wybor;
        cout << "\n";
...
//wyszukiwanie elementu
            case 7:
                ...
                if (indeks < 0) {
                    ...
                    cout << "Wartość występuje na indeksie: " << indeks << " Czas operacji: " << czas.czasWykonania()<< endl;
                }
                break;
...
//wyświetlanie listy
            ...
            case 9:
                ...
                for (liczby; liczby > 0; liczby--) {
                    file >> wartoscZPliku;
                    lista.dodawanieNaKoniec(wartoscZPliku);
                }
...
void Test::testKopca() {
    ...
    do {
        ...
        cout << "    5. Wstaw dane z pliku" << endl;
        cout << "    0. Wyjście" << endl;
        cout << "Wybór: ";
        cin >> wybor;
        cout << "\n";
...
//wyswietlanie kopca
            ...
            case 5:
                ...
                for (liczby; liczby > 0; liczby--) {
                    file >> wartoscZPliku;
                    kopiecBinarny.dodaj(wartoscZPliku);
                }
